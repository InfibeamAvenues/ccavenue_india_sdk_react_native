...
const initiatePayment = async () => {
  ...
  const order = {
    ...
    environment: 'production', // 'qa' | 'production' | 'uat' (Default: production)
    appColor: '#FFFFFF', // Hex Color Code (Default: #1F46BD)
    fontColor: '#000000', // Hex Color Code (Default: #FFFFFF)
...
{
  "statusCode": 106, 
  "statusMessage": "No payment options are available for this transaction."
}
```
...
| **paymentEnvironment** | String | Payment environment configuration. <br> **Default:** "production" <br> **Possible values:** `production`, `uat`, `qa` | No |
